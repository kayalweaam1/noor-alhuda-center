  ...
  return (
    <div className="min-h-screen" dir="rtl">
      <div className="p-6 space-y-6">
          ...
          <Card className="border-emerald-200">
            ...
            <CardContent>
              ...
              <div className="flex items-start gap-3 p-3 bg-gray-50 rounded-lg border border-gray-200">
                  ...
                  <div className="flex-1">
                    <p className="font-semibold text-gray-900">درس المساء</p>
                    <p className="text-sm text-gray-700">4:00 مساءً - 6:00 مساءً</p>
                    <p className="text-xs text-gray-600 mt-1">حلقة {teacher?.halaqaName || 'القرآن'}</p>
                  </div>
                </div>
              </div>
            </CardContent>
        ...
        <Card className="border-gray-200">
          <CardHeader>
            <CardTitle className="text-gray-900">النشاط الأخير</CardTitle>
